...
import { hydrateDrawerFromInspect, portsFromRowDisplay } from './dockerHelpers'

export type InspectDrawerProps = {
  row: ContainerRow
  networks: NetworkRow[]
  onClose: () => void
          ...
          {drawerTab === 'volumes' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              ...
              {volumeMounts.length === 0 ? (
                ...
                volumeMounts.map((v: string | Record<string, unknown>, i: number) => (
                  <div
                    key={i}
                    className="mono"
                    style={{
