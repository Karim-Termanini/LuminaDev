                    ...
                    <>
                      ...
                      {!remapTargetHasHostBinding ? (
                        ...
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, alignItems: 'flex-end' }}>
                          ...
                          <label style={{ display: 'flex', flexDirection: 'column', gap: 6, fontSize: 13 }}>
                            <span style={{ fontWeight: 600 }}>{t('ports.newHostPort')} <span style={{ fontWeight: 400, color: 'var(--text-muted)' }}>({t('ports.sameKeepPort')})</span></span>
                            <input
                              className="hp-input"
                              type="number"
                              min={1}
        ...
        {tab === 'cleanup' ? (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
            ...
            <div style={{ ...sectionBox, border: '1px solid var(--orange)' }}>
              <h3 style={{ margin: 0, fontSize: 16, color: 'var(--orange)' }}>{t('cleanup.safetyNote')}</h3>
      ...
      <div className="docker-inspect-drawer__body">
        ...
        {drawerTab === 'logs' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8, height: '100%' }}>
            ...
            <pre style={{ fontSize: 11, whiteSpace: 'pre-wrap', wordBreak: 'break-all', margin: 0, color: 'var(--text)', background: 'rgba(0, 0, 0, 0.2)', padding: 12, borderRadius: 6, minHeight: '300px', flex: 1, overflow: 'auto' }}>
