...
import { formatRuntimeVersionDisplay } from './utils'
...
export function RuntimeSidebar({ vm }: RuntimeSidebarProps): ReactElement {
  const { t, runtimes, selectedId, setSelectedId, setShowWizard, refreshStatus, isRefreshing } = vm
